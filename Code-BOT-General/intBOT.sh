#!/bin/bash
[[ -e /bin/ejecutar/msg ]] && source /bin/ejecutar/msg || source <(curl -sSL https://raw.githubusercontent.com/DanssBot/Generador-BOT/main/Otros/msg)
bar="$(msg -bar3)"
...
msg -bar
echo -e " \033[7;49;35m ${TTini} 🐲 BotGEN DARINEL${TTcent}ADM $(cat ${CIDdir}/vercion) 🐲 ◄◄<===   \033[0m"
msg -bar
