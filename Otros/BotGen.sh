...
if [[ ! -e ${newresell} ]]; then
echo "@cisdan" > ${SCPT_DIR}/message.txt 
else
...
bot_retorno+="$LINE\n"
bot_retorno+=" 👀 𝗞𝗘𝗬 𝗚𝗘𝗡𝗘𝗥𝗔𝗗𝗔𝗦:  [  $(ls /etc/http-shell/ | grep name | wc -l) ]\n"
...
ShellBot.InlineKeyboardButton --button 'botao_send_id' --line 1 --text "SOLIC" --callback_data '/acceso'
...
ShellBot.InlineKeyboardButton --button 'botao_user' --line 1 --text 'BOT' --callback_data '1' --url 'https://www.paypal.me/Rufu99'
ShellBot.InlineKeyboardButton --button 'botao_user' --line 2 --text 'PTT' --callback_data '1' --url 'https://t.me/ChumoGHADM'
ShellBot.InlineKeyboardButton --button 'botao_user' --line 2 --text 'NOSE' --callback_data '1' --url 'https://t.me/ChumoGH_ADM'
